    ...
    <div style={{fontFamily:'Inter,sans-serif',background:tema.sfondo_pagina||'#fff',minHeight:'100vh'}}>
      ...
      <div style={{
        ...
        <div className="lp-hero-logo" style={{position:'relative',zIndex:1,textAlign:'center',width:'100%',marginBottom:'36px'}}>
          <img src={logoSrc} alt="CNA Roma" style={{height:logoAltezza+'px',objectFit:'contain',filter: lh.logo_filtro==='nessuno' ? 'none' : lh.logo_filtro==='nero' ? 'brightness(0)' : 'brightness(0) invert(1)'}} />
        </div>
      ...
      <footer style={{background:tema.sfondo_footer||'#0A0A0A',padding:'36px 24px',textAlign:'center'}}>
        <img src={logoSrc} alt="CNA Roma" style={{height:'36px',objectFit:'contain',filter: lh.logo_filtro==='nessuno' ? 'none' : lh.logo_filtro==='nero' ? 'brightness(0)' : 'brightness(0) invert(1)',marginBottom:'12px',display:'block',margin:'0 auto 12px'}} />
