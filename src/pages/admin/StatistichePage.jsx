...
function ThIcon({ icon: Icon, label, color='#003DA5', bg='#EBF0FA' }) {
  return (
                ...
                <table style={{ width:'100%', borderCollapse:'collapse', fontSize:'13px' }}>
                  ...
                  <tbody>
                    {filteredUtenti.slice(0, 50).map((u, idx) => {
                      ...
                      return (
                        <tr key={idx}
                          style={{ borderBottom:'1px solid #F3F4F6', backgroundColor: isSelected ? '#EBF0FA' : 'transparent', cursor:'pointer', transition:'background-color .1s' }}
                          onClick={() => selectUtente(u)}
                          onMouseEnter={e => { if (!isSelected) e.currentTarget.style.backgroundColor='#F9FAFB' }}
                          onMouseLeave={e => { e.currentTarget.style.backgroundColor = isSelected ? '#EBF0FA' : 'transparent' }}>
                          <td style={s.td}>
                            <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
                              <div style={{ width:28, height:28, borderRadius:'50%', background:'linear-gradient(135deg,#003DA5,#BE123C)', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
                          ...
                          <td style={s.td}>
                            <div style={{ display:'flex', alignItems:'center', gap:'6px' }}>
                              <div style={{ width:36, height:5, backgroundColor:'#F3F4F6', borderRadius:3, overflow:'hidden' }}>
                                <div style={{ width:`${tasso}%`, height:'100%', background:`linear-gradient(90deg,${tasso>=80?'#059669':tasso>=50?'#D97706':'#003DA5'},${tasso>=80?'#10b981':tasso>=50?'#f59e0b':'#BE123C'})`, borderRadius:3 }}/>
                              </div>
            ...
            <div>
              <div style={{ backgroundColor:'#fff', borderRadius:'10px', border:'1px solid #E5E7EB', padding:'20px', marginBottom:'16px' }}>
                <div style={{ display:'flex', alignItems:'center', gap:'12px', marginBottom:'16px' }}>
                  <div style={{ width:44, height:44, borderRadius:'50%', background:'linear-gradient(135deg,#003DA5,#BE123C)', display:'flex', alignItems:'center', justifyContent:'center' }}>
