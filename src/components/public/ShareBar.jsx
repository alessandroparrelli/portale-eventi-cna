...
export default function ShareBar({ event }) {
  ...
  // Testo completo per WhatsApp e Email
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', gap: '10px', justifyContent: 'center', flexWrap: 'wrap' }}>
        ...
        <button type="button" onClick={handleCopy}
          style={btnStyle(copied ? '#16A34A' : '#F3F4F6', copied ? '#fff' : '#374151')}>
