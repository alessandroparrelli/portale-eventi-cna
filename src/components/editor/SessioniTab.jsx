            ...
            <div style={{ gridColumn:'1/-1' }}>
              <Field label="Note / Descrizione">
                <textarea
                  ...
                  rows={3}
                  style={{ width:'100%', boxSizing:'border-box', border:'1px solid #D1D5DB', borderRadius:'20px', padding:'9px 12px', fontSize:'13px', fontFamily:"'Outfit',sans-serif", resize:'vertical', outline:'none', color:'#0A0A0A' }}
                />
              </Field>
            </div>
          </div>
...
export default function SessioniTab({ event, setEvent }) {
  ...
  return (
    <div>
      {/* Intro */}
      <div style={{ backgroundColor:'#EFF6FF', border:'1px solid #BFDBFE', borderRadius:'20px', padding:'14px 16px', marginBottom:'24px', display:'flex', gap:'12px', alignItems:'flex-start' }}>
      ...
      {sessioni.length > 0 && (
        <div style={{ marginTop:'20px', padding:'14px', backgroundColor:'#F9FAFB', borderRadius:'20px', border:'1px solid #E5E7EB' }}>
...
const st = {
  card: { backgroundColor:'#ffffff', border:'1px solid #E5E7EB', borderRadius:'20px', overflow:'hidden' },
  ...
  sessionNum: { width:'28px', height:'28px', borderRadius:'50%', backgroundColor:'#EBF0FA', color:'#003DA5', fontSize:'12px', fontWeight:'800', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 },
  ...
  iconBtn: { display:'flex', alignItems:'center', justifyContent:'center', width:'28px', height:'28px', background:'none', border:'none', borderRadius:'20px', cursor:'pointer', color:'#6B7280', fontSize:'14px', fontWeight:'700', fontFamily:"'Outfit',sans-serif" },
  grid2: { display:'grid', gridTemplateColumns:'1fr 1fr', gap:'12px', paddingTop:'14px' },
  empty: { textAlign:'center', padding:'48px 24px', border:'2px dashed #E5E7EB', borderRadius:'20px', display:'flex', flexDirection:'column', alignItems:'center' },
  addBtnPrimary: { display:'flex', alignItems:'center', gap:'8px', backgroundColor:'#003DA5', color:'#fff', border:'none', borderRadius:'20px', padding:'10px 20px', fontSize:'14px', fontWeight:'700', cursor:'pointer', fontFamily:"'Outfit',sans-serif" },
  addBtn: { display:'flex', alignItems:'center', gap:'8px', border:'1px dashed #D1D5DB', backgroundColor:'transparent', borderRadius:'20px', padding:'12px 20px', fontSize:'13px', fontWeight:'600', cursor:'pointer', fontFamily:"'Outfit',sans-serif", color:'#374151', width:'100%', justifyContent:'center' },
}
