...
const st = {
  ...
  addBtnPrimary: { display:'flex', alignItems:'center', gap:'8px', backgroundColor:'#003DA5', color:'#fff', border:'none', borderRadius:'6px', padding:'10px 20px', fontSize:'14px', fontWeight:'700', cursor:'pointer', fontFamily:"'Outfit',sans-serif" },
